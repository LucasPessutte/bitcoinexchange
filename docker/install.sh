...
docker exec -d platform_frontend bash -c "rm -rf /platform_frontend/package-lock.json"
docker exec -d platform_backend bash -c "rm -rf /platform_backend/node_modules"
docker exec -d platform_backend bash -c "rm -rf /platform_backend/package-lock.json"
echo "Done"